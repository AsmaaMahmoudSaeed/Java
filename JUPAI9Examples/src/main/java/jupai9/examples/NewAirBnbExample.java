...
// applay linear regression on AirBnb DATASET
    public static void main(String[] args) throws IOException {
        // Create Spark Session to create connection to Spark
        final SparkSession sparkSession = SparkSession.builder().appName("AirBnb Spark Linear Regression Example")
        ...
        // testing).
        Dataset<Row>[] splits = featuresData.randomSplit(new double[] { 0.7, 0.3 },41);
        ...
        if(model == null) {
            ...
            final LinearRegression linear_reggresion = new LinearRegression().setLabelCol("price")
                    .setFeaturesCol("features");

            // Using pipeline gives you benefit of switching regression model without any other changes
            final Pipeline pipeline = new Pipeline()
                    .setStages(new PipelineStage[] { linear_reggresion });
